...
Feed.create(:title=>'Destructoid', :site=>'www.destructoid.com', :url=>'feeds.feedburner.com/Destructoid', :created_at=>'1900-01-01 00:00:00', :updated_at=>'1900-01-01 00:00:00')
...
Entry.create(:title=>'Initial Entry', :description=>'Initial Entry', :link=>'feemon.com', :created_at=>'1900-01-01 00:00:00', :updated_at=>'1900-01-01 00:00:00', :published=>'1900-01-01 00:00:00')
Dashboard.create(:user_id=>'1', :created_at=>'1900-01-01 00:00:00', :updated_at=>'1900-01-01 00:00:00', :feed_id=>'1', :entry_id=>'1', :read =>'false', :entry_title=>'Test dashboard', :entry_published=>'1900-01-01 00:00:00', :entry_link=>'feemon.com')
